...
function DizelGeneratory() {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const res = await axios.get(`https://django-admin-pro.onrender.com/api/dizel_generatory/products/?${query}`);
    ...
    useEffect(() => {
        fetch(`https://django-admin-pro.onrender.com/api/dizel_generatory/api/products-page/?page=${page}`)
            .then(res => res.json())
            .then(data => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch(
                    `https://django-admin-pro.onrender.com/api/dizel_generatory/products-list/?ordering=${ordering}`
                );
                        ...
                        <div className="col-md-12">
                            <div className="page-header-box">
                                ...
                                <h1 className="text-anime">
                                    {lang === 'uz' ? "Dizel generatorlar" : "Дизель генераторы"}
                                </h1>
