...
function EraSolar() {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const res = await axios.get(`https://django-admin-pro.onrender.com/api/era_solar/products/?${query}`);
    ...
    useEffect(() => {
        fetch(`https://django-admin-pro.onrender.com/api/era_solar/api/products-page/?page=${page}`)
            .then(res => res.json())
            .then(data => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch(
                    `http://django-admin-pro.onrender.com/api/era_solar/products-list/?ordering=${ordering}`
                );
