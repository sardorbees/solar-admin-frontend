...
import 'rc-slider/assets/index.css'; // стандартные стили
import '../assets/css/price.css';
...
const SolarPanelList = () => {
    ...
    const fetchPowers = async () => {
        try {
            const res = await axios.get("https://django-admin-pro.onrender.com/api/shop_category/power/");
            setPowers(res.data);
        } catch (error) {
...
function Project() {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const res = await axios.get(`https://django-admin-pro.onrender.com/api/shop_category/products/?${query}`);
    ...
    useEffect(() => {
        fetch(`https://django-admin-pro.onrender.com/api/shop_category/api/products-page/?page=${page}`)
            .then(res => res.json())
            .then(data => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch(
                    `https://django-admin-pro.onrender.com/api/shop_category/products-list/?ordering=${ordering}`
                );
                        ...
                        <div className="col-md-12">
                            <div className="page-header-box">
                                ...
                                <h1 className="text-anime">
                                    {lang === 'uz' ? "Mahsulotlarimiz" : "Наши Товары"}
                                </h1>
                            </div>
                        </div>
                    </div>
