...
function HzSolar() {
    ...
    useEffect(() => {
        fetch(`https://django-admin-pro.onrender.com/api/hz_solar/api/products-page/?page=${page}`)
            .then(res => res.json())
            .then(data => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch(
                    `https://django-admin-pro.onrender.com/api/hz_solar/products-list/?ordering=${ordering}`
                );
