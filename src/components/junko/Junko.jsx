...
function Junko() {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const res = await axios.get(`https://django-admin-pro.onrender.com/api/junko/products/?${query}`);
    ...
    useEffect(() => {
        fetch(`https://django-admin-pro.onrender.com/api/junko/api/products-page/?page=${page}`)
            .then(res => res.json())
            .then(data => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch(
                    `https://django-admin-pro.onrender.com/api/junko/products-list/?ordering=${ordering}`
                );
