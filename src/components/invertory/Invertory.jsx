...
function Invertory() {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const res = await axios.get(`https://django-admin-pro.onrender.com/api/invertory/products/?${query}`);
    ...
    useEffect(() => {
        fetch(`https://django-admin-pro.onrender.com/api/invertory/api/products-page/?page=${page}`)
            .then(res => res.json())
            .then(data => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch(
                    `http://django-admin-pro.onrender.com/api/invertory/products-list/?ordering=${ordering}`
                );
